...
> Styling: Tailwind CSS (dark theme, smooth scrolling, fade/slide transitions)

> Backend/Integration: Gemini AI (customer support chatbot integration)


> Utilities: Intersection Observer API for animations, structured constants and services modules
...
> Profile details and career history (from structured content files)

> AI-powered insights via Gemini integration
...
Interactive chatbot powered by Gemini AI for real-time engagement
Transparent roadmap section: from first DM to final delivery
Responsive design with text alignment fixes across devices

> Expandable features: testimonials, social media feed, case studies, enhanced contact form
...
> Services Section: Clear breakdown of offered services and future roadmap
